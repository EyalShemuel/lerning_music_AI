...
// C:\inetpub\wwwroot\my projects\INT\fullstuck-class\projects\lerning_music_AI\client\src\Components\pages\Main\AI\SoundClassifier.js
/* todo */
...
const url = 'https://teachablemachine.withgoogle.com/models/iF2ClR4MV/';
...
function SoundClassifier({ notesObject, setNotesObject, keys }) {
  ...
  useEffect(() => {
    ...
    // function will run when we get any errors or results
